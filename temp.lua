...
data:extend(
{
  ...
  },
  {
    ...
    inventory_size = 2000,
    build_distance = 1000,
    drop_item_distance = 1000,
    reach_distance = 1000,
    item_pickup_distance = 100,
    loot_pickup_distance = 2,
    enter_vehicle_distance = 10,
    reach_resource_distance = 100,
    grounded_landing_search_radius = 100,
  ...
  },
  {
    ...
    pickup_position = {0, -1},
    insert_position = {0, 1.2},
    energy_per_movement = "7J",
    energy_per_rotation = "7J",
    energy_source =
    {
      type = "electric",
      usage_priority = "secondary-input",
